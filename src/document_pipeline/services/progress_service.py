...
class ProgressService:
    ...
    def stage_duration_ms(self, started_at: datetime | None, completed_at: datetime | None) -> int | None:
    ...
    def extraction_progress(self, run: RunRecord) -> StageProgress:
        ...
        return StageProgress(
            ...
            duration_ms=self.stage_duration_ms(run.extraction_started_at, run.extraction_completed_at),
        )
    ...
    def classification_progress(self, run: RunRecord) -> StageProgress:
        ...
        return StageProgress(
            ...
            duration_ms=self.stage_duration_ms(run.classification_started_at, run.classification_completed_at),
        )
